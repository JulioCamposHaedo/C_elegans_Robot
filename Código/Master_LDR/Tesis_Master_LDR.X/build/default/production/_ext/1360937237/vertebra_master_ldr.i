...
# 2 "<built-in>" 2
# 1 "../src/vertebra_master_ldr.c" 2
# 1 "../src/vertebra_master_ldr.h" 1
...
void Read_Slave_Sensors(uint8_t esclavo){
    ...
    valor2 = I2C_Read1ByteRegister(esclavo,2);
    valorLuz= ((uint16_t)((valor1 << 8) + valor2));

    valor3= I2C_Read1ByteRegister(esclavo,3);
    valor4 = I2C_Read1ByteRegister(esclavo,4);
    valorLuz2= ((uint16_t)((valor3 << 8) + valor4));


    if (valorLuz > 512 && valorLuz2 < 512){

        I2C_Write1ByteRegister(esclavo,15,cicloMin);
    }
    else if(valorLuz < 512 && valorLuz2 > 512)
    {
        I2C_Write1ByteRegister(esclavo,15,cicloMax);
    }
    else if(valorLuz > 512 && valorLuz2 > 512)
    {
        I2C_Write1ByteRegister(esclavo,15,cicloReposo);
    }
    else
    {
        I2C_Write1ByteRegister(esclavo,15,cicloReposo);
